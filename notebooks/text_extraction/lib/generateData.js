...
module.exports = function(file) {
  // text2png requires the name of the font and using the
  // font's filename might not be reliable
  try {
    let font = fontkit.openSync(file);

    return font.fullName + " " + file;

    // fs.writeFileSync('out.png', text2png('with custom fonts', {
    //   font: `32px Zrnic`,
    //   padding: 5,
    //   backgroundColor: 'white',
    //   localFontPath: '/home/eksoverzero/Sites/ada-ai-notebook/notebooks/sentiment_analysis/fonts/zrnic__.ttf',
    //   localFontName: 'Zrnic'
    // }));
  } catch(err) {
    console.log(err);
